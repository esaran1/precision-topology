...
minimiser itself. Landed so far: a = 1.30 at R₂ = 0.001, a = 1.30 at R₂ = 0.003, a = 1.50 at R₂ = 0.001, a = 1.50 at R₂ = 0.003 (placed cancelling pair at each, every validation passed, the best unplaced
configuration on the G = 0 boundary, at least 99× the tie tolerance above); **4 scale(s) PENDING** (table in WP-8, not
