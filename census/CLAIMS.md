...
| T10 | **Fold layer 1**: separating runs change linking at layer 1 | qualified: holds in **every dense-verified trace** — corrugation 5/5, parametrization 17/18 (one layer-2 exception, itself dense-verified), baseline 2 (+1 marginal), witness by construction. The strong corrugation negative ("fold stays at 1 at 18× embeddedness, frequency 200") is **restated**: dense-verified support covers only mild corrugation (4 configs + flat, none at published amplitude); whether strong corrugation moves the fold is open | dense-verified traces as listed; witness trace lk −1→0 at fold, residual 2e−15 | measurement | 512-point traces under-resolve deep distorted nets (fixed: 8,192 + convergence gate); corrugated trace resolution not re-audited | `dense_check.md` addendum, `corrugation_results.md` restatement, `witness.md`, `localization_results.md` |
