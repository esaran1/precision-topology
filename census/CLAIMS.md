...
| T21 | **Regional separation collapses above mild corrugation**: dense-verified GELU width-3 separations exist only at amplitude ≤ 0.05 or frequency ≤ 50 (plus embedded arms); 0 in 360 strong-group runs bounds the strong-group regional rate below 0.83% against 1.9% observed mild. Survivor concentration conditional on separating: p = 0.016 (post-hoc split). Consistent with corrugation making the task regionally unsolvable at width 3; a small undetected rate (~0.6–0.8%) cannot be excluded at current n. Reading B has zero dense survivors anywhere (0/11; 1/11 under best-of-three) | current, power-limited | 630 GELU width-3 corrugation runs joined with dense check | count + bound | mild/strong split drawn at observed boundary; per-config n = 30 underpowered alone | `corrugation_dense_rates.md` |
